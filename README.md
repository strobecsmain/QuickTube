...
Расширение **QuickTube** (также известное как **FreeTube**) больше не поддерживается. Мы прекратили разработку и поддержку этого проекта, и теперь вместо него выпущено новое приложение — **QuickNet Solution**.

QuickNet Solution — это более современное и функциональное решение для просмотра видео с улучшенной производительностью, безопасностью и дополнительными возможностями. Мы рекомендуем вам перейти на QuickNet Solution для получения всех последних обновлений и новых функций.

Скачайте QuickNet Solution и оставайтесь с нами!  
https://strobecsmain.github.io/QuickNet-AntiDPI/
